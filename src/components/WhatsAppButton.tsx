...
export default function WhatsAppButton({ whatsappNumber }: { whatsappNumber?: string }) {
  const handleClick = () => {
    ...
    const message = encodeURIComponent('Hola, me interesa un producto de Amelia’s Stationery');
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.9 }}
      onClick={handleClick}
      className="fixed bottom-8 right-8 z-50 p-4 bg-[#25D366] text-white rounded-full shadow-2xl hover:bg-[#128C7E] transition-all"
